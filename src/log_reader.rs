...
impl FormatType {
    pub fn to_f64(&self) -> Option<f64> {
        match self {
            ...
            FormatType::Int16Mul100(n) => Some((*n / 100) as f64),
            FormatType::Uint16Mul100(n) => Some((*n / 100) as f64),
            FormatType::Int32Mul100(n) => Some((*n / 100) as f64),
            FormatType::Uint32Mul100(n) => Some((*n / 100) as f64),
            FormatType::Int32LatLon(n) => None,
            FormatType::Uint8FlightMode(n) => None,
